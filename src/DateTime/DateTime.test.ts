...
describe("DateTime should", () => {
  ...
  it("retrieve the previous month", () => {
    expect(
      new DateTime("2020-11-25T12:00:00.000Z").previousMonth().toString()
    ).toBe("2020-10-25T12:00:00.000Z");
    expect(
      new DateTime("2020-05-15T12:00:00.000Z").previousMonth().toString()
    ).toBe("2020-04-15T12:00:00.000Z");
    expect(
      new DateTime("2020-11-30T12:00:00.000Z").previousMonth().toString()
    ).toBe("2020-10-30T12:00:00.000Z");
    expect(
      new DateTime("2020-02-20T12:00:00.000Z").previousMonth().toString()
    ).toBe("2020-01-20T12:00:00.000Z");
    expect(
      new DateTime("2021-01-20T12:00:00.000Z").previousMonth().toString()
    ).toBe("2020-12-20T12:00:00.000Z");
    expect(
      new DateTime("2020-03-31T12:00:00.000Z").previousMonth().toString()
    ).toBe("2020-02-29T12:00:00.000Z");
    expect(
      new DateTime("2019-03-31T12:00:00.000Z").previousMonth().toString()
    ).toBe("2019-02-28T12:00:00.000Z");
  });
});
